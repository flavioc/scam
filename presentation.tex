...
\begin{frame}{User-defined Pointcuts}
  ...
  \begin{block}{An example:}
    \verb!pointcut pointcutOne() : execute (* methodOne(..)) \&\& execute(* methodTwo(..));
  \end{block}
\end{frame}
...
%------------------------------Technical Details-----------------------------------------------------
%Não faria mais sentido depois da demonstração? Digo isto apenas porque sucede ao join point model..., e porque após a explicação da sintaxe do aspectj, a (primeira?) demo ficaria bem...
